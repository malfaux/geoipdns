...
/* we're watching IN_OPEN because one may force data reload by 'touch'-ing the cdb file */
//#define EV_MASK IN_ATTRIB|IN_MODIFY|IN_DELETE
#ifdef USE_TOUCH_RELOADS
#warning "using touch reloads"
#define EV_MASK IN_DELETE_SELF|IN_OPEN
#else
#define EV_MASK IN_DELETE
#endif
#undef EV_MASK
#define EV_MASK IN_ATTRIB
